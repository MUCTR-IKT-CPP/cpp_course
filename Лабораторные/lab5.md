...
Создайте класс Фигура с методами площадь() и периметр(), а также защищенными полями для хранения размеров. Реализуйте геттеры и сеттеры для доступа к данным.

...
1. Контейнер и данные: Создай vector пар (pair), где первый элемент 1  случайное целое число (от 1 до 10), а второй 1  случайное число с плавающей точкой (от 0.0 до 1.0). Заполни вектор 25 такими парами.
...
1. Контейнер и данные: Создай map, где ключ 1 это номер (целое число от 1 до N), а значение 1 это vector из 5 случайных целых чисел (от 1 до 100).
...
1. Замыкание для гистограммы: Создай внешний map, где ключ 1 цифра, а значение 1 количество ее вхождений. Напиши лямбда-функцию, которая захватывает эту мапу по ссылке. Лямбда должна принимать число и увеличивать соответствующий счетчик в мапе.
